...
\begin{enumerate}
    ...
    \item Since the relative error is $\left|\dfrac{p*-p}{p}\right| \leq 10^{-4}$, $p - p*10^{-4} \leq p* \leq p + p*10^{-4}$.
    \begin{enumerate}
        \item $[\pi - \pi*10^{-4}, \pi + \pi*10^{-4}]$
        \item $[e - e*10^{-4}, e + e*10^{-4}]$
        \item $[\sqrt{2} - \sqrt{2}*10^{-4}, \sqrt{2} + \sqrt{2}*10^{-4}]$
        \item $[\sqrt[3]{7} - \sqrt[3]{7}*10^{-4}, \sqrt[3]{7} + \sqrt[3]{7}*10^{-4}]$
    \end{enumerate}
\end{enumerate}
\end{document}
