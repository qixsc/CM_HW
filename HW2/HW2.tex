...
\begin{enumerate}
    ...
    For a, \begin{align*}
        \lim_{n\to\infty} \dfrac{p_{n+1} - \sqrt[3]{21}}{p_n - \sqrt[3]{21}} &= \lim_{n\to\infty} \dfrac{20p_n^3 + 21 - 21\cdot \sqrt[3]{21}p_n^2}{21 p_n^3 - 21\sqrt[3]{21}p_n^2}\\
    \end{align*}

    Thus, order of speed of convergence is b > d > a.
