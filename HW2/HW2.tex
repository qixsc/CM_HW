...
\begin{enumerate}
    ...
    \item \begin{enumerate}
        ...
        \item Let $h_1 = 0-1 = -1$, $h_2 = 1 - 2 = -2$.
        Then, $\delta_1 = \dfrac{P(0) - P(1)}{h_1} = \dfrac{-6 - (-2)}{-1} = 4$, 
        $\delta_2 = \dfrac{P(1) - P(2)}{h_2} = \dfrac{-2 - (-2)}{-1} = 0$, 
        $d = \dfrac{\delta_2 - \delta_1}{h_2 + h_1} = \dfrac{0 - 4}{-2} = 2$.

        Thus, $b = 0 + (-2)\cdot 2 = -4$ and $D = \sqrt{(-4)^2 - 4\cdot (-2)\cdot 2} = 4\sqrt{2}$.
        Since $|b - D| > |b + D|$, $E = -4 - 4\sqrt{2}$.
        Therefore, $h = \dfrac{-2\cdot (-2)}{-4 - 4\sqrt{2}} = \dfrac{1}{-1-\sqrt{2}} \approx -0.414213562373$,
        and $p = 2 + h \approx 1.5857864376$
    \end{enumerate}
\end{enumerate}
\end{document}
