...
\begin{enumerate}
    ...
    Then, running python and observe the function, 
    we get a is linearly convergence, b is quadratic convergence (Newton's method), and d is suplinear converges.
    Meanwhile, though $\sqrt[3]{21}$ is a fixed point of c, but it will diverges or converges to $0$ for any open interval contains $\sqrt[3]{21}$.

    Thus, order of speed of convergence is b > d > a > c.
