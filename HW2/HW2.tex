...
\begin{enumerate}
    ...
    \item \begin{enumerate}
        \item Suppose $\displaystyle\lim_{n\to\infty} \dfrac{|20p_n + 21/p_{n-1}^2 - \sqrt[3]{21}|}{|20p_{n-1} + 21/p_{n-2}^2 - \sqrt[3]{21}|^q} = r$.
        Then, assume $q = 1$,
        
        $\displaystyle\lim_{n\to\infty} \dfrac{20p_n + 21/p_{n-1}^2 - \sqrt[3]{21}}{20p_{n-1} + 21/p_{n-2}^2 - \sqrt[3]{21}} = $
    \end{enumerate}
\end{enumerate}
\end{document}
